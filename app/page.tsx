...
// ✅ FIX: Disable SSR for animation components
const EnhancedBackground = dynamic(
  () => import("@/components/enhanced-background"),
  { ssr: false }
)

const CursorSparkle = dynamic(
  () => import("@/components/cursor-sparkle"),
  { ssr: false }
)
...
export default function Portfolio() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 overflow-x-hidden">
      ...
      {/* These were causing hydration error → now fixed */}
      <EnhancedBackground />
      <CursorSparkle />
